 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | L1   |  Esc | LAlt | LCtrl | LGui|                                       |  Left  | Down | Up | Right| L1    |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Left | Right|       | RGui  |RCtrl|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        KC_SCOLON,      KC_Q,    KC_J,   KC_K,   KC_X,   KC_LGUI,
        KC_FN1,         KC_ESC,         KC_LALT, KC_LCTL,KC_LGUI,
        ...
        // right hand
             KC_RALT,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_BSLS,
             KC_RBRC,     KC_F,   KC_G,   KC_C,   KC_R,   KC_L,             KC_SLSH,
                          KC_D,   KC_H,   KC_T,   KC_N,   KC_S,             KC_MINS,
             KC_LGUI,     KC_B,   KC_M,   KC_W,   KC_V,   KC_Z,             KC_RSFT,
